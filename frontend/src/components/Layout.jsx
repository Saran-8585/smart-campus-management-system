...
import {
  ...
  ChevronRight, Map, MapPin, Package
} from 'lucide-react'
...
const roleMenus = {
  admin: [
    ...
    { label: 'Marks', path: '/admin/marks', icon: BarChart3 },
  ...
  faculty: [
    ...
    { label: 'Marks', path: '/faculty/marks', icon: BarChart3 },
  ...
  student: [
    ...
    { label: 'Marks', path: '/student/marks', icon: BarChart3 },
